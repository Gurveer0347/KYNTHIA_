...
# MongoDB connection - initialization is lazy to avoid errors if env vars aren't set during build
...
# For Vercel, we don't strictly need the shutdown event but it's good practice
